...
[상호명 및 업종업태 판독 규칙]
- SHOP 라인의 '업종및가게성격'은 '상호명 + 매장주소'를 결합해 지도 포털에 검색했을 때 나오는 공식 등록 업종·업태 및 매장 성격을 발췌하여 아주 짧은 한 문장으로 정리하십시오.
  * 예: '회원제 대형 할인마트', '테이크아웃 및 매장 이용 전문 카페', '자가용 주유 및 세차 서비스 주유소'
    ...
    const response = await fetch(apiUrl, {
      ...
      body: JSON.stringify({
        ...
        contents: [
          {
            parts: [
              { text: "영수증 이미지의 유통사별 형태와 할인 구조를 분석하여 [출력 양식]에 맞춰 줄 단위로 정확히 추출하시오. 업종및가게성격은 상호명과 주소를 바탕으로 지도 검색 기반의 명확한 한 문장으로 정리하고, 품목 목록이 없는 승인 전표는 [상호명] 이용료 형태의 단일 ITEM으로 구성하시오." },
