...
- overallElements에는 품목별 할인이 아닌, 영수증 전체에 적용된 일괄 할인(포인트 사용 등)과 추가 비용(봉투값 등)만 포함하십시오. 영수증 전체 일괄 할인의 항목명은 반드시 "전체일괄할인"으로 통일하십시오.`;
    ...
    const promptText = `영수증 이미지를 분석하여 아래 포맷의 순수 JSON으로만 응답하시오:
{
  ...
  "address": "매장주소",
  "overallElements": [
    { "name": "항목명 (주의: 부가세, 결제금액, 총합계 절대 제외. 전체일괄할인 및 봉투값 등만 기재)", "amount": "할인은 -금액, 추가는 +금액" }
  ],
  "products": [
    {
