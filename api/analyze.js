...
[핵심 규칙 - 제품명 복원 및 유통사/품번 특화 지침]
- 영수증에 인쇄된 줄임말, 약어, 또는 제품코드(품번)를 적극 활용하여 실제 시중에 유통되는 정확한 표준 제품명으로 'productAi'를 완성하라.
- 대형 유통사 및 PB 상품의 경우, 일반 쇼핑몰에 잘 나오지 않으므로 실시간 검색 도구를 통해 해당 유통사의 공식 명칭이나 전용 품번 기준의 명칭을 추적하라.
- 존재하지 않는 가상의 제품명을 절대 창조하지 말 것.
...
주의사항: 부가세는 포함하지 말 것. 제품 개별 할인은 products 내부에, 결제 단계에서의 전체 가감액은 overallElements에 기입하라.

{
  ...
  "address": "매장주소",
  "overallElements": [
    { "name": "전체 할인/가산 항목명", "type": "discount 또는 fee", "amount": "금액" }
  ],
  "products": [
    {
      "productOcr": "영수증판독 제품명 및 품번/코드",
      "productAi": "실제 검색된 정확한 표준 제품명",
      "recoveryProcess": "복원 프로세스 요약",
      "logicReview": "무결성 검토",
      "quantity": "수량",
      "originalPrice": "제품 1개 정가 또는 총 정가",
